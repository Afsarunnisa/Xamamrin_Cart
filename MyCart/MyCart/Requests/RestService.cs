...
namespace MyCart.Data
{
    public class RestService : IRestService
    {
        ...
        public async Task<Boolean> AddWishListItem(string productID){


            var wishListUrlStr = Constants.WishListUrl + productID;
			var url = string.Format(wishListUrlStr);
        ...
        public async Task<List<Products>> GetWishList()
        {
			var wishListUrlStr = Constants.WishListUrl;
			var url = string.Format(wishListUrlStr);
        ...
        public async Task<Order> ConfirmCart(){
            ...
            try{
				...
				Order order = JsonConvert.DeserializeObject<Order>(respContent);
        ...
        public async Task<string> ConfirmPutCart()
        {
			var url = string.Format(Constants.ConfirmUrl);
			var uri = new Uri(url);
            ...
            try{
				...
				OrderStatus order = JsonConvert.DeserializeObject<OrderStatus>(respContent);
