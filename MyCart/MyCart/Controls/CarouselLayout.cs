...
namespace MyCart.Controls
{
    public class CarouselLayout : ScrollView
    {
		...
		// We manage "pages" of data by creating a bindable IList property as our ItemsSource.
		// Anytime we update the ItemsSource, we add our page items as children of the StackLayout.
